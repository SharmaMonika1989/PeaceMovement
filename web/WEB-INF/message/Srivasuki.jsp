                                                    ...
                                                    <div class="PT10">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <div class="row" style="margin-left: -120px;">
                                                                ...
                                                                <p style="font-size:16px; color:#cc0000; font-family:arial; text-align:center; font-weight: bold; padding-top: 35px ">Honourable Dr. K.P. Srivasuki, <br>IFS.Addl Principal Chief Conservator ofForests and,<br> Chief Executive Officer,A.P. Medicinal & Aromatic Plants Board</p><br>
                                                                    <center>  <img class="img" src="message/SrivasukiJi-msg.gif" alt="Paris" width="553" height="757"></center><br>
                                                                        <br><br><br>
